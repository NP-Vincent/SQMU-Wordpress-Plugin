...
<div class="wp-block-group sqmu-listing-buy">
  <h3 class="wp-block-heading sqmu-heading">SQMU Purchase</h3>
  ...
  <div class="wp-block-buttons">
    ...
    <div class="wp-block-button">
      <button id="disconnect" class="wp-block-button__link sqmu-hidden">Disconnect</button>
    </div>
  </div>

  <div class="wp-block-group">
    <label for="sqmu-amount" class="has-text-align-center sqmu-field-label">SQMU Amount</label>
    <input id="sqmu-amount" type="number" value="0.01" step="0.01" class="wp-block-input">
  </div>

  <div class="wp-block-group">
    <label for="token-select" class="has-text-align-center sqmu-field-label">Payment Token</label>
  ...
  <div class="wp-block-group">
    <label for="agent-code" class="has-text-align-center sqmu-field-label">Agent Code (optional)</label>
    <input id="agent-code" type="text" class="wp-block-input">
  </div>

  <div class="wp-block-group">
    <label for="buyer-email" class="has-text-align-center sqmu-field-label">Email (optional)</label>
